...
def main():
    ...
    p.add_argument('--userdata-dir', default=str(Path.cwd() / 'userdata'), action=fixPathAction, help="Workspace directory.")
    ...
    p.add_argument('--input-dir', required=True, action=fixPathAction, help="FaceSynthetics directory.")
    p.add_argument('--faceset-path', required=True, action=fixPathAction, help="output .dfs path")
    p.set_defaults(func=run_extract_FaceSynthetics)

    train_parser = subparsers.add_parser( "train", help="Train neural network.")
    train_parsers = train_parser.add_subparsers(dest='train_target', required=True)
    ...
    p.add_argument('--workspace-dir', required=True, action=fixPathAction, help="Workspace directory.")
    p.add_argument('--faceset-path', required=True, action=fixPathAction, help=".dfs path")
